...
func writeSchemas(dir string) error {
  ...
  "$defs": {
    ...
    "cap":{"type":"object","additionalProperties":false,"required":["requests","outputTokens"],"properties":{"requests":{"type":"integer","minimum":0,"maximum":6144},"outputTokens":{"type":"integer","minimum":0,"maximum":25165824}}},
